# Form implementation generated from reading ui file 'c:\Users\MustUser\Desktop\PyCut\uic\mainwindow.ui'
#
...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap("c:\\Users\\MustUser\\Desktop\\PyCut\\uic\\../icon/crop.png"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
...
"    }")
        ...
        self.cutImageWidget.setGeometry(QtCore.QRect(670, 360, 255, 255))
...
"")
        ...
        icon1 = QtGui.QIcon()
        icon1.addPixmap(QtGui.QPixmap("c:\\Users\\MustUser\\Desktop\\PyCut\\uic\\../icon/up-left-arrow.png"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
...
"    }")
        ...
        icon2 = QtGui.QIcon()
        icon2.addPixmap(QtGui.QPixmap("c:\\Users\\MustUser\\Desktop\\PyCut\\uic\\../icon/up-arrow.png"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
...
"    }")
        ...
        icon3 = QtGui.QIcon()
        icon3.addPixmap(QtGui.QPixmap("c:\\Users\\MustUser\\Desktop\\PyCut\\uic\\../icon/up-right-arrow.png"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
...
"    }")
        ...
        icon4 = QtGui.QIcon()
        icon4.addPixmap(QtGui.QPixmap("c:\\Users\\MustUser\\Desktop\\PyCut\\uic\\../icon/left-arrow.png"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
...
"    }")
        ...
        icon5 = QtGui.QIcon()
        icon5.addPixmap(QtGui.QPixmap("c:\\Users\\MustUser\\Desktop\\PyCut\\uic\\../icon/four-arrows.png"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
...
"    }")
        ...
        icon6 = QtGui.QIcon()
        icon6.addPixmap(QtGui.QPixmap("c:\\Users\\MustUser\\Desktop\\PyCut\\uic\\../icon/right-arrow.png"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
...
"")
        ...
        icon7 = QtGui.QIcon()
        icon7.addPixmap(QtGui.QPixmap("c:\\Users\\MustUser\\Desktop\\PyCut\\uic\\../icon/down-left-arrow.png"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
...
"    }")
        ...
        icon8 = QtGui.QIcon()
        icon8.addPixmap(QtGui.QPixmap("c:\\Users\\MustUser\\Desktop\\PyCut\\uic\\../icon/down-arrow.png"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
...
"    }")
        ...
        icon9 = QtGui.QIcon()
        icon9.addPixmap(QtGui.QPixmap("c:\\Users\\MustUser\\Desktop\\PyCut\\uic\\../icon/down-right-arrow.png"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
...
"    }")
        ...
        self.layoutWidget2.setGeometry(QtCore.QRect(550, 390, 51, 173))
        ...
        self.splitter.setGeometry(QtCore.QRect(0, 0, 545, 690))
...
"}")
        ...
        self.contrastdoubleSpinBox.setGeometry(QtCore.QRect(860, 625, 62, 20))
        ...
        self.contrastSlider.setGeometry(QtCore.QRect(680, 625, 171, 20))
        ...
        self.label.setGeometry(QtCore.QRect(740, 645, 51, 20))
        font = QtGui.QFont()
        ...
        icon10 = QtGui.QIcon()
        icon10.addPixmap(QtGui.QPixmap("c:\\Users\\MustUser\\Desktop\\PyCut\\uic\\../icon/add-image.png"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        self.menuOpen.setIcon(icon10)
        self.menuOpen.setObjectName("menuOpen")
        self.menuSave = QtGui.QAction(parent=MainWindow)
        icon11 = QtGui.QIcon()
        icon11.addPixmap(QtGui.QPixmap("c:\\Users\\MustUser\\Desktop\\PyCut\\uic\\../icon/save-image.png"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
